        ...
        <div className="modal-body">
          {!user && (
            <div className="info-banner">
              Sign in to unlock personalized offers and auto-apply savings.
            </div>
          )}
              ...
              {offers.map((o) => (
                <div key={o.id} className="offer-card">
                  ...
                  <div className="offer-details">
                    ...
                    <span className="min">Min Rs {o.minOrder}</span>
                  </div>
                  <div className="offer-features">
                    <small>Save up to Rs {o.maxDiscount}</small>
                  </div>
          ...
          <div className="offers-info">
            ...
            <p className="micro-copy">Use the best eligible offer at checkout to maximize savings.</p>
          </div>
        </div>
      </div>
    </div>
